...
from flask_jwt_extended import (
    JWTManager, jwt_refresh_token_required, get_jwt_identity,
...
# Setup flask-sqlalchemy. In this example we will use an in-memory sqlite3
# db for ease of use. In production, I recommend using postgres
